...
export const formacion = [
  {
    ...
    company: "Universidad Tecnológica de Huejotzingo",
    date: "2023 - 2025",
    description:
      "Consolidé mis conocimientos en desarrollo de software adquiriendo experiencia en Java y JavaScript, complementada con formación autodidacta en librerías y tecnologías modernas. Desarrollé competencias en arquitectura de software, metodologías ágiles y buenas prácticas de programación, fortaleciendo además habilidades clave como pensamiento crítico, resolución de problemas y colaboración efectiva en entornos de desarrollo.",
  },
  {
    title: "TSU en Tecnologías de la Información — Área Desarrollo de Software Multiplataforma",
    company: "Universidad Tecnológica de Huejotzingo",
    date: "2021 - 2023",
    description:
      "Construí bases sólidas en Java, JavaScript e Internet de las Cosas, ampliando mis conocimientos con estudio autodidacta en diversas librerías y frameworks. Este periodo reforzó mis capacidades técnicas, la lógica de programación y habilidades blandas como el trabajo en equipo, la comunicación y la adaptabilidad ante nuevos desafíos tecnológicos.",
  },
  {
    ...
    date: "2018 - 2021",
    description:
      "Adquirí fundamentos sólidos en programación, bases de datos y desarrollo de software, comenzando con C++ y C#. También obtuve experiencia inicial en desarrollo web y móvil, aplicando principios de diseño y escalabilidad para crear aplicaciones funcionales, lo que marcó el inicio de mi vocación como desarrollador.",
  },
];
